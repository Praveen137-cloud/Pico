...
const Profile = () => {
  ...
  const currentAvatarEmoji = avatarMap[user.avatar] || '🦜';
                ...
                {avatarsList.map(av => (
                  ...
                  >
                    <div className="profile-avatar-emoji">
                      {av.name === 'Parrot' ? (
                        <img src="/pico-bird.png" alt="Parrot" style={{ width: 40, height: 40, objectFit: 'contain' }} />
                      ) : av.emoji}
                    </div>
                    <div className="profile-avatar-name">{av.label}</div>
                  </div>
                ))}
             </div>
          </div>
