const p1 = [
  {
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "The Triage! A Heap is a special Tree-based data structure where the most important bird always sits at the top! 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "Think of it as a vertical queue. It\'s a Complete Binary Tree, meaning every level is full except possibly the last, which is filled from left to right! 🦜"' },
      { type: 'multiple_choice', questionText: 'A Heap is based on which underlying data structure?', options: ['Complete Binary Tree', 'Linked List', 'Stack'], correctAnswer: 'Complete Binary Tree' },
      { type: 'match_following', questionText: 'Match Heap basics!', pairs: [{key: 'Complete Tree', value: 'Structure rule'}, {key: 'Top node', value: 'Highest priority'}, {key: 'Left-to-Right', value: 'Filling rule'}] },
      { type: 'programming_board', questionText: 'A heap must be a ___ binary tree.', codeSnippet: 'Structure = ___ ;', correctAnswer: 'complete' },
      { type: 'teaching', questionText: 'By Pico: "Complexity: Finding the top element is O(1). This is why Heaps are the gods of priority! 🦜"' },
      { type: 'multiple_choice', questionText: 'Can a Heap be used as a Queue?', options: ['Yes (Priority Queue)', 'No', 'Only for birds'], correctAnswer: 'Yes (Priority Queue)' },
      { type: 'code_fill_in', questionText: 'Root index (usually).', codeSnippet: 'int root = index ___ ;', correctAnswer: '0' },
      { type: 'teaching', questionText: 'By Pico: "Priority first! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Who is at the top?"', options: ['The most important!', 'No.', '0'], correctAnswer: 'The most important!' }
    ]
  },
  {
    order: 2,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "The Strongest First! In a Max-Heap, every parent bird must be GREATER than or equal to its children. 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "This means the absolute largest value in the entire forest is guaranteed to be at the root (index 0)! 🦜"', codeSnippet: 'parent >= left_child\nparent >= right_child' },
      { type: 'multiple_choice', questionText: 'In a Max-Heap, where is the maximum value?', options: ['At the root', 'At the leaves', 'In the middle'], correctAnswer: 'At the root' },
      { type: 'match_following', questionText: 'Match Max-Heap logic!', pairs: [{key: 'Root', value: 'Global maximum'}, {key: 'Parent', value: '>= Child'}, {key: 'Property', value: 'Max-Heap'}] },
      { type: 'programming_board', questionText: 'Max-Heap condition for node `i`.', codeSnippet: 'heap[i] ___ childrenValues;', correctAnswer: '>=' },
      { type: 'teaching', questionText: 'By Pico: "Complexity: O(1) to find Max. O(log N) to maintain the property after changes. 🦜"' },
      { type: 'multiple_choice', questionText: 'Is [10, 8, 9, 2, 3] a Max-Heap?', options: ['Yes', 'No (8 < 2?)', 'No (9 < 3?)'], correctAnswer: 'Yes' },
      { type: 'code_fill_in', questionText: 'Parent of index i.', codeSnippet: 'parentIndex = (i - 1) ___ 2;', correctAnswer: '/' },
      { type: 'teaching', questionText: 'By Pico: "Ascending power! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Is the biggest bird on top?"', options: ['SQUAWK YES!', 'No.', '0'], correctAnswer: 'SQUAWK YES!' }
    ]
  },
  {
    order: 3,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "The Lightest First! In a Min-Heap, every parent bird must be SMALLER than or equal to its children. 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "This puts the absolute smallest value at the root. Perfect for finding the closest bird or the cheapest seed! 🦜"', codeSnippet: 'parent <= left_child\nparent <= right_child' },
      { type: 'multiple_choice', questionText: 'In a Min-Heap, where is the minimum value?', options: ['At the root', 'At the bottom', 'Random'], correctAnswer: 'At the root' },
      { type: 'match_following', questionText: 'Match Min-Heap logic!', pairs: [{key: 'Root', value: 'Global minimum'}, {key: 'Parent', value: '<= Child'}, {key: 'Property', value: 'Min-Heap'}] },
      { type: 'programming_board', questionText: 'Min-Heap condition for node `i`.', codeSnippet: 'heap[i] ___ childrenValues;', correctAnswer: '<=' },
      { type: 'teaching', questionText: 'By Pico: "O(1) to find Min. Just like Max-Heaps, it is efficient and orderly! 🦜"' },
      { type: 'multiple_choice', questionText: 'Is [1, 5, 3, 10, 8] a Min-Heap?', options: ['Yes (1 < 5,3. 5 < 10,8)', 'No', '0'], correctAnswer: 'Yes (1 < 5,3. 5 < 10,8)' },
      { type: 'code_fill_in', questionText: 'Left child of index i.', codeSnippet: 'leftChild = 2 * i ___ 1;', correctAnswer: '+' },
      { type: 'teaching', questionText: 'By Pico: "Descending order! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Is the smallest bird on top?"', options: ['SQUAWK YES!', 'No.', '0'], correctAnswer: 'SQUAWK YES!' }
    ]
  },
  {
    order: 4,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "No pointers needed! Because the tree is complete, we can map it to a simple array without wasting space! 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "For node at index `i`: Left Child is `2*i + 1`, Right Child is `2*i + 2`, and Parent is `(i-1)/2`! 🦜"', codeSnippet: 'left(i) = 2i + 1\nright(i) = 2i + 2\nparent(i) = (i-1)/2' },
      { type: 'multiple_choice', questionText: 'Index of the right child of node at index 3?', options: ['8', '7', '6'], correctAnswer: '8' },
      { type: 'match_following', questionText: 'Match Array math!', pairs: [{key: '2i + 1', value: 'Left wing'}, {key: '2i + 2', value: 'Right wing'}, {key: '(i-1)/2', value: 'The parent source'}] },
      { type: 'programming_board', questionText: 'The formula for finding the parent of index `idx`.', codeSnippet: 'parentIdx = (idx - 1) ___ 2;', correctAnswer: '/' },
      { type: 'teaching', questionText: 'By Pico: "Fast and cache-friendly! No overhead for objects, just pure index math. 🦜"' },
      { type: 'multiple_choice', questionText: 'What is the parent of node at index 0?', options: ['Doesn\'t exist (returns 0)', '1', '-1'], correctAnswer: 'Doesn\'t exist (returns 0)' },
      { type: 'code_fill_in', questionText: 'Find left child.', codeSnippet: 'int L = ___ * i + 1;', correctAnswer: '2' },
      { type: 'teaching', questionText: 'By Pico: "Mapped excellence! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Can you navigate the array?"', options: ['SQUAWK YES!', 'No.', '0'], correctAnswer: 'SQUAWK YES!' }
    ]
  },
  {
    order: 5,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "Joining the Rank! To add a bird, put it at the very bottom (end of array) then let it climb until it finds its proper rank! 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "Up-Heapify (Percolate Up): Compare the new bird with its parent. If it violates the heap rule, SWAP and repeat! 🦜"', codeSnippet: 'void upHeap(i) {\n  while(i > 0 && heap[parent(i)] < heap[i]) {\n    swap(heap[i], heap[parent(i)]);\n    i = parent(i);\n  }\n}' },
      { type: 'multiple_choice', questionText: 'Time complexity of inserting into a Heap of N elements?', options: ['O(log N)', 'O(N)', 'O(1)'], correctAnswer: 'O(log N)' },
      { type: 'match_following', questionText: 'Match Insertion steps!', pairs: [{key: 'Add to end', value: 'Maintain complete tree'}, {key: 'Compare parent', value: 'Check property'}, {key: 'Swap', value: 'Ascend to rank'}] },
      { type: 'programming_board', questionText: 'Direction of movement for a newly inserted element.', codeSnippet: 'Movement = ___ ;', correctAnswer: 'upwards' },
      { type: 'teaching', questionText: 'By Pico: "O(log N) because the tree is balanced and the maximum height is logarithmic! 🦜"' },
      { type: 'multiple_choice', questionText: 'What happens if the new bird is smaller than its parent in a Max-Heap?', options: ['It stays where it is', 'It disappears', 'It swaps anyway'], correctAnswer: 'It stays where it is' },
      { type: 'code_fill_in', questionText: 'Swap with parent.', codeSnippet: 'swap(heap[i], heap[___]);', correctAnswer: '(i-1)/2' },
      { type: 'teaching', questionText: 'By Pico: "Rising to power! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Did I reach the top?"', options: ['If I am the best!', 'No.', '0'], correctAnswer: 'If I am the best!' }
    ]
  },
  {
    order: 6,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "Sovereign Exit! To remove the leader bird, copy the LAST bird in the forest to the root, remove the last bird, then let the new leader fall to its proper rank! 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "Down-Heapify (Sink): Compare the root with its children. Swap with the LARGER child (for Max-Heap) until the property is restored! 🦜"', codeSnippet: 'void sink(i) {\n  largest = i;\n  if(L < n && heap[L] > heap[largest]) largest = L;\n  if(R < n && heap[R] > heap[largest]) largest = R;\n  if(largest != i) { swap(i, largest); sink(largest); }\n}' },
      { type: 'multiple_choice', questionText: 'Time complexity of deleting the root from a Heap?', options: ['O(log N)', 'O(1)', 'O(N)'], correctAnswer: 'O(log N)' },
      { type: 'match_following', questionText: 'Match Deletion steps!', pairs: [{key: 'Swap root with last', value: 'Ready to remove'}, {key: 'Pop last', value: 'Leader is gone'}, {key: 'Sink the root', value: 'Restore property'}] },
      { type: 'programming_board', questionText: 'In a Max-Heap Sink, which child do you swap with?', codeSnippet: 'Swap with the ___ child.', correctAnswer: 'larger' },
      { type: 'teaching', questionText: 'By Pico: "O(log N). Always swap with the larger child in a Max-Heap to ensure the new parent is greater than BOTH children! 🦜"' },
      { type: 'multiple_choice', questionText: 'Why not swap with the smaller child in a Max-Heap?', options: ['The smaller child might still be smaller than the other child', 'It is forbidden', 'Pico rule'], correctAnswer: 'The smaller child might still be smaller than the other child' },
      { type: 'code_fill_in', questionText: 'Check right child.', codeSnippet: 'if (R < n && heap[R] > heap[___]) largest = R;', correctAnswer: 'largest' },
      { type: 'teaching', questionText: 'By Pico: "Falling to balance! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Is the order restored?"', options: ['SQUAWK YES!', 'No.', '0'], correctAnswer: 'SQUAWK YES!' }
    ]
  },
  {
    order: 7,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "The Quick Glance! Checking who the leader is takes almost zero energy. 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "Peek: Returns `heap[0]`. O(1). Size: Returns the current number of birds in the array. O(1). 🦜"', codeSnippet: 'int getMax() { return heap[0]; }\nint size() { return heap.size(); }' },
      { type: 'multiple_choice', questionText: 'Complexity of finding the maximum in a Max-Heap?', options: ['O(1)', 'O(log N)', 'O(N)'], correctAnswer: 'O(1)' },
      { type: 'match_following', questionText: 'Match Stats!', pairs: [{key: 'getMax()', value: 'Peek at root'}, {key: 'size()', value: 'Population count'}, {key: 'pop()', value: 'Extraction'}] },
      { type: 'programming_board', questionText: 'Element returned by `heap[0]` in a Min-Heap.', codeSnippet: 'Result = ___ value;', correctAnswer: 'minimum' },
      { type: 'teaching', questionText: 'By Pico: "Finding the champion is instant. Replacing them is the hard part! 🦜"' },
      { type: 'multiple_choice', questionText: 'If the heap is empty, what should peek return?', options: ['Error or sentinel', '0', '1'], correctAnswer: 'Error or sentinel' },
      { type: 'code_fill_in', questionText: 'Access root.', codeSnippet: 'return ___[0];', correctAnswer: 'heap' },
      { type: 'teaching', questionText: 'By Pico: "Instant vision! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Is the leader visible?"', options: ['SQUAWK YES!', 'No.', '0'], correctAnswer: 'SQUAWK YES!' }
    ]
  },
  {
    order: 8,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "The Balanced Forest! Because every level must be full, the height of a heap is always the shortest possible for N nodes. 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "Height = `floor(log2(N))`. This means even with 1 MILLION birds, the height is only 19! 🦜"', codeSnippet: 'Height = floor(log2(N))' },
      { type: 'multiple_choice', questionText: 'Height of a heap with 7 nodes?', options: ['2', '3', '7'], correctAnswer: '2' },
      { type: 'match_following', questionText: 'Match Height logic!', pairs: [{key: 'N = 15', value: 'Height 3'}, {key: 'N = 31', value: 'Height 4'}, {key: 'Property', value: 'Perfect balance'}] },
      { type: 'programming_board', questionText: 'Max height of a heap with N nodes.', codeSnippet: 'Max Height = O( ___ );', correctAnswer: 'log N' },
      { type: 'teaching', questionText: 'By Pico: "The logarithmic height is what makes insertions and deletions so incredibly fast! 🦜"' },
      { type: 'multiple_choice', questionText: 'Does heap height change during extraction?', options: ['Yes (might decrease)', 'No', '0'], correctAnswer: 'Yes (might decrease)' },
      { type: 'code_fill_in', questionText: 'Log base for height.', codeSnippet: 'h = floor(log ___ (N));', correctAnswer: '2' },
      { type: 'teaching', questionText: 'By Pico: "Short and powerful! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Is the tree tall?"', options: ['Short elite!', 'No.', '0'], correctAnswer: 'Short elite!' }
    ]
  },
  {
    order: 9,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "The Abstract Bird! A Priority Queue is an idea (ADT) where items are extracted by priority. A HEAP is the best way to implement it! 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "In most languages, `PriorityQueue` is a Min-Heap or Max-Heap under the hood. 🦜"', codeSnippet: 'pq.push(x);\npq.top();\npq.pop();' },
      { type: 'multiple_choice', questionText: 'What is the relationship between Heap and Priority Queue?', options: ['Heap is an implementation of Priority Queue', 'They are the same', '0'], correctAnswer: 'Heap is an implementation of Priority Queue' },
      { type: 'match_following', questionText: 'Match Priority tools!', pairs: [{key: 'Push', value: 'Insertion'}, {key: 'Pop', value: 'Extraction of top'}, {key: 'Priority', value: 'Ranking criteria'}] },
      { type: 'programming_board', questionText: 'Operation to remove the most important bird.', codeSnippet: 'pq. ___ ();', correctAnswer: 'pop' },
      { type: 'teaching', questionText: 'By Pico: "Use Max-PQ for scores and Min-PQ for times. The forest is all about priorities! 🦜"' },
      { type: 'multiple_choice', questionText: 'Default Priority Queue in C++ is?', options: ['Max-Heap', 'Min-Heap', 'Random'], correctAnswer: 'Max-Heap' },
      { type: 'code_fill_in', questionText: 'Push element.', codeSnippet: 'pq. ___ (val);', correctAnswer: 'push' },
      { type: 'teaching', questionText: 'By Pico: "Organized flight! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Do you have priorities?"', options: ['SQUAWK YES!', 'No.', '0'], correctAnswer: 'SQUAWK YES!' }
    ]
  },
  {
    order: 10,
    ...
    lessons: [
      { type: 'teaching', questionText: 'By Pico: "STAGE 1 COMPLETE! You have decoded the Royal structure of Heaps! 🦜"' },
      { type: 'teaching', questionText: 'By Pico: "Max, Min, Array Maps, and the Upward/Downward flows of balance. You are a priority master! 🦜"' },
      { type: 'multiple_choice', questionText: 'Max-Heap property?', options: ['Parent >= Children', 'Parent <= Children'], correctAnswer: 'Parent >= Children' },
      { type: 'multiple_choice', questionText: 'Left child formula?', options: ['2i + 1', '2i + 2'], correctAnswer: '2i + 1' },
      { type: 'multiple_choice', questionText: 'Complexity to find max?', options: ['O(1)', 'O(log N)'], correctAnswer: 'O(1)' },
      { type: 'multiple_choice', questionText: 'Insertion complexity?', options: ['O(log N)', 'O(1)'], correctAnswer: 'O(log N)' },
      { type: 'multiple_choice', questionText: 'Relationship between Heap/PQ?', options: ['Heap implements PQ', 'PQ implements Heap'], correctAnswer: 'Heap implements PQ' },
      { type: 'match_following', questionText: 'Final Foundation Match!', pairs: [{key: 'Heap', value: 'Ordered!'}, {key: 'Priority', value: 'Sorted!'}, {key: 'Pico', value: 'Salutes!'}] },
      { type: 'teaching', questionText: 'By Pico: "Next, we face the Intermediate Stage: Heapify, Heap-Sort, and the Medians of the Forest! SQUAWK! 🦜"' },
      { type: 'multiple_choice', questionText: 'By Pico: "Are you ready to sort the world?"', options: ['BEYOND AND UP!', 'Wait...', '0'], correctAnswer: 'BEYOND AND UP!' }
    ]
  },
  {
    order: 11,
  ...
  },
  {
    ...
    lessons: [
      ...
      { type: 'teaching', questionText: 'By Pico: "The backbone of Dijkstra’s Algorithm (Decrease-Key). Keeping ranks current is vital! 🦜"' },
